...
{
    partial class Popup_InfirmacoesDoSoftware : Form
    {
        private const string TAG = "Popup_InfirmacoesDoSoftware";

        public Popup_InfirmacoesDoSoftware()
        {
            InitializeComponent();
        ...
        private void CarregarTema()
        {
            try
            {
                ...
                textBoxDescription.ForeColor =
                ForeColor = TemaConfig.TextColorPrimary;

                textBoxDescription.BackColor = TemaConfig.ColorPrimaryDark;
            }
            catch (Exception ex)
            {
                Log.Erro(TAG, ex);
